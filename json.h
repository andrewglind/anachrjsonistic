// Generated by Hatchet (https://github.com/andrewglind/hatchet) v0.3.3
#ifndef JSON_H
#define JSON_H
...
namespace json {
	...
	return ((this->__this != NULL ? this->__this->isString() : false)) ? ((float) atof(this->__this->s.c_str())) : 0.0f;
	}
